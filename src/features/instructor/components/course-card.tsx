...
export const CourseCard = () => {
  return (
    <Card className="pt-0 pb-3 gap-2">
      <Image
        alt="eat_sleep_code_repeat"
        className="!w-full"
        height={100}
        quality={100}
        src="https://images.unsplash.com/photo-1590959651373-a3db0f38a961?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=739"
        width={300}
      />
